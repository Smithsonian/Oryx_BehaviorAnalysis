...
# Fit model
jm2=jags.model("Multinomial_NewFormulation.R",data=data.list,n.chains=3,n.adapt=n.adapt)
update(jm2, n.iter=n.update) # Burn-in the chain
zm2=coda.samples(jm2,variable.names=c("alpha","PROBS"), n.iter=n.iter, n.thin=1)
