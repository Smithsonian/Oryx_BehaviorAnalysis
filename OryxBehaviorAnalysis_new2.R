...
# **********************************************
# To make this a little clearer, restrict the variables included in graphing
# Remove oov (Out of View) - Not interesting
test <- test[,1:24]
t3 <- t3[1:24]
MCMCplot(test, labels=c(t3), xlim=c(-3,3))
...
# Headshake + scratch
head <- test[,c(7:9,19:21)]
thead <- t3[c(7:9,19:21)]
MCMCplot(head, labels=c(thead), xlim=c(-2,2))

# Walk + social
walk <- test[,c(10:12,22:24)]
twalk <- t3[c(10:12,22:24)]
MCMCplot(walk, labels=c(twalk), xlim=c(-2,2))

MCMCplot(walk, labels=c(twalk),xlim=c(-2,2),labels_sz=1, 
         med_sz=1, thick_sz = 2.5, thin_sz = 1.25, ax_sz = 2.75, 
         x_axis_text_sz = 1.25, x_tick_text_sz = 1, mar = c(5.1, 4.1, 4.1, 2.1))

MCMCplot(walk, labels=c("","Walking","","","Social",""),xlim=c(-2,2),labels_sz=1, 
         med_sz=1, thick_sz = 2.5, thin_sz = 1.25, ax_sz = 2.75, 
         x_axis_text_sz = 1.25, x_tick_text_sz = 1, mar = c(5.1, 4.1, 4.1, 2.1))

MCMCplot(walk, labels=NULL,xlim=c(-2,2),labels_sz=1, 
         med_sz=1, thick_sz = 2.5, thin_sz = 1.25, ax_sz = 2.75, 
         x_axis_text_sz = 1, x_tick_text_sz = 1, mar = c(5,8,5,8), ref=0)
abline(h=3.5, lty=2, col=1)
#mtext("test",side=2, line=-2, at=5, adj=0, padj=0, las=2,cex=1)
mtext("(A)",side=2,at=5.5,adj=1.5,las=2,cex=1)
#mtext("(B)",side=4,at=7,adj=2,las=2,cex=1)
#mtext("Walking",side=2,at=5,adj=1,las=2,cex=1)
#mtext("Social",side=2,at=2,adj=1,las=2,cex=1)

mtext("< Control",side=2,at=6,adj=0,las=2,cex=0.75)
mtext("< Control",side=2,at=5,adj=0,las=2,cex=0.75)
mtext("< Trtmt 1",side=2,at=4,adj=0,las=2,cex=0.75)

mtext("< Control",side=2,at=3,adj=0,las=2,cex=0.75)
mtext("< Control",side=2,at=2,adj=0,las=2,cex=0.75)
mtext("< Trtmt 1",side=2,at=1,adj=0,las=2,cex=0.75)

mtext("Trtmt 1 >",side=4,at=6,adj=2.25,las=2,cex=0.75)
mtext("Trtmt 2 >",side=4,at=5,adj=1.5,las=2,cex=0.75)
mtext("Trtmt 2 >",side=4,at=4,adj=1.5,las=2,cex=0.75)

mtext("Trtmt 1 >",side=4,at=3,adj=1.5,las=2,cex=0.75)
mtext("Trtmt 2 >",side=4,at=2,adj=1.5,las=2,cex=0.75)
mtext("Trtmt 2 >",side=4,at=1,adj=1.5,las=2,cex=0.75)


par(mfrow=c(1,2))
# Headshake + scratch + SHU + SHD
head <- test[,c(7:8,19:20,1:2,4:5)]
thead <- t3[c(7:8,19:20,1:2,4:5)]
MCMCplot(head, labels=c(thead), xlim=c(-2,2))

# Walk + social + FHU + FHD
walk <- test[,c(10:11,22:23,13:14,16:17)]
twalk <- t3[c(10:11,22:23,13:14,16:17)]
MCMCplot(walk, labels=c(twalk), xlim=c(-2,2))

MCMCplot(head, labels=NULL,xlim=c(-2,2),labels_sz=1, 
         med_sz=1, thick_sz = 2.5, thin_sz = 1.25, ax_sz = 2.75, 
         x_axis_text_sz = 1, x_tick_text_sz = 1, mar = c(6,10,6,8), ref=0)
abline(h=2.5, lty=2, col=1)
abline(h=4.5, lty=2, col=1)
abline(h=6.5, lty=2, col=1)
#mtext("test",side=2, line=-2, at=5, adj=0, padj=0, las=2,cex=1)
mtext("Headshaking",side=2,at=8.5,adj=0.75,las=2,cex=1)
mtext("Scratching",side=2,at=6.5,adj=0.75,las=2,cex=1)
mtext("Standing (HU)",side=2,at=4.5,adj=0.75,las=2,cex=1)
mtext("Standing (HD)",side=2,at=2.5,adj=0.75,las=2,cex=1)

for (i in 1:8){
  mtext("< Control",side=2,at=i,adj=0,las=2,cex=0.75)
}

mtext("Trtmt 1 >",side=4,at=2,adj=2.25,las=2,cex=0.75)
mtext("Trtmt 1 >",side=4,at=4,adj=2.25,las=2,cex=0.75)
mtext("Trtmt 1 >",side=4,at=6,adj=2.25,las=2,cex=0.75)
mtext("Trtmt 1 >",side=4,at=8,adj=2.25,las=2,cex=0.75)

mtext("Trtmt 2 >",side=4,at=1,adj=2.25,las=2,cex=0.75)
mtext("Trtmt 2 >",side=4,at=3,adj=2.25,las=2,cex=0.75)
mtext("Trtmt 2 >",side=4,at=5,adj=2.25,las=2,cex=0.75)
mtext("Trtmt 2 >",side=4,at=7,adj=2.25,las=2,cex=0.75)
...
abline(h=6.5, lty=2, col=1)
#mtext("test",side=2, line=-2, at=5, adj=0, padj=0, las=2,cex=1)
mtext("Walking",side=2,at=8.5,adj=1,las=2,cex=1)
mtext("Social",side=2,at=6.5,adj=1,las=2,cex=1)
mtext("Feeding (HU)",side=2,at=4.5,adj=1,las=2,cex=1)
mtext("Feeding (HD)",side=2,at=2.5,adj=1,las=2,cex=1)

for (i in 1:8){
  mtext("< Control",side=2,at=i,adj=0.5,las=2,cex=0.75)
}
