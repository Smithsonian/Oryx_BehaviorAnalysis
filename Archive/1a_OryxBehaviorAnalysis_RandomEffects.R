...
# What's the time of the study period for Loretta
Loretta <- subset(bdata.control, Animal == "Loretta")

difftime(as.Date(Loretta$Date[1],format = "%m/%d/%Y"),as.Date(Loretta$Date[nrow(Loretta)],format = "%m/%d/%Y"))
